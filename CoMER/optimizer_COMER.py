...
from train_optuna import train_test_COMER_model

GPUS = 1

work_dir = ''
#log_file_name = 'optimize_HME_100k_reduced_CAN'
log_file_name = 'optimize_Base_Soma_Subtr_COMER'
...
def evaluation_trial(trial):
    ...
    params = dict(seed_everything='7',
                        ...
                        model={'d_model': trial.suggest_categorical('d_model', [64, 128, 256]),  # default: 256
                               ...
                               'dc': trial.suggest_categorical('dc', [4, 8, 16]), # default: 16,
    ...
    test_exp_rate, train_loss = train_test_COMER_model(params=params, trial=trial)
