...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        #print("\nX.SIZE em densenet: " + str(x.size()))
        out = self.conv1(x)
        #print("out.conv1 em densenet: " + str(out.size()))
        out = F.relu(out, inplace=True)
        #print("out.relu em densenet: " + str(out.size()))
        out = F.max_pool2d(out, 2, ceil_mode=True)
        #print("out.pool em densenet: " + str(out.size()))
        out = self.dense1(out)
        #print("out.dense1 em densenet: " + str(out.size()))
        out = self.trans1(out)
        #print("out.trans1 em densenet: " + str(out.size()))
        out = self.dense2(out)
        #print("out.dense2 em densenet: " + str(out.size()))
        out = self.trans2(out)
        #print("out.trans2 em densenet: " + str(out.size()))
        out = self.dense3(out)
        #print("out.dense3 em densenet: " + str(out.size()))
        return out
